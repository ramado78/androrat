...
public class wavIO {
	...
	public void setHeaders() {
		...
		myByteRate = 20050; // 11025 * 2 car 11025 nb samples 1 sec et 1 sample
							// 16 donc 2 bytes
	...
	public boolean save2() {
		try {
			...
			// write the wav file per the wav file format
			outFile.writeBytes("RIFF"); // 00 - RIFF
			outFile.writeInt(Integer.reverseBytes((int) myChunkSize)); // 04 -
																		// how
																		// big
																		// is
																		// the
			...
			outFile.writeBytes("WAVE"); // 08 - WAVE
			outFile.writeBytes("fmt "); // 12 - fmt
			outFile.writeInt(Integer.reverseBytes((int) mySubChunk1Size)); // 16
																			// -
																			// size
																			// of
																			// this
																			// chunk
			outFile.writeShort(Short.reverseBytes((short) myFormat)); // 20 -
																		// what
																		// is
																		// the
																		// audio
																		...
																		// Code
																		// Modulation
			outFile.writeShort(Short.reverseBytes((short) myChannels)); // 22 -
																		// mono
																		// or
																		// stereo?
																		// 1 or
																		...
																		// or
																		// ???)
			outFile.writeInt(Integer.reverseBytes((int) mySampleRate)); // 24 -
																		// samples
																		// per
																		// second
																		// (numbers
																		// per
																		// second)
			outFile.writeInt(Integer.reverseBytes((int) myByteRate)); // 28 -
																		// bytes
																		// per
																		// second
			outFile.writeShort(Short.reverseBytes((short) myBlockAlign)); // 32
																			// -
																			// #
																			// of
																			// bytes
																			...
																			// all
																			// channels
			outFile.writeShort(Short.reverseBytes((short) myBitsPerSample)); // 34
																				// -
																				// how
																				// many
																				// bits
																				...
																				// 24
			outFile.writeBytes("data"); // 36 - data
			outFile.writeInt(Integer.reverseBytes((int) myDataSize)); // 40 -
																		// how
																		// big
																		// is
																		// this
