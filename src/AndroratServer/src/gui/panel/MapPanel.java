...
public class MapPanel extends JPanel {
	...
	public MapPanel(UserGUI gui) {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addContainerGap()
						.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 624,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addComponent(splitPane, GroupLayout.PREFERRED_SIZE,
								545, Short.MAX_VALUE).addContainerGap()));
		...
		panel_2.setBorder(new TitledBorder(null, "Start group",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(
				...
				gl_panel.createSequentialGroup()
						.addContainerGap()
						.addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 238,
								Short.MAX_VALUE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 151,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(btnCenterView).addGap(161)));
		...
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(
				...
				.addGroup(
						gl_panel_1
								...
								.addGap(18).addComponent(lblLastData)
								.addPreferredGap(ComponentPlacement.RELATED)
	...
	private void centerMapView() {
		mapViewer.setDisplayPositionByLatLon(lastLatitude, lastLongitude,
				mapViewer.getZoom());
	}
	...
	private void fireButtonStreaming() {
		if (streaming) {
			...
			if (rdbtnNetwork.isSelected())
				provider = "network";
			else if (rdbtnGps.isSelected())
				provider = "gps";
	...
	public void updateMap(double longitude, double latitude, double altitude,
