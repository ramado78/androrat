...
public class VideoPanel extends JPanel {
	 ...
	 */
	private static final String[][] ASPECTS = { { "<choose...>", null },
			{ "16:10", "16:10" }, { "16:9", "16:9" }, { "1.85:1", "185:100" },
			{ "2.21:1", "221:100" }, { "2.35:1", "235:100" },
			{ "2.39:1", "239:100" }, { "5:3", "5:3" }, { "4:3", "4:3" },
			{ "5:4", "5:4" }, { "1:1", "1:1" } };
	...
	public VideoPanel(UserGUI gui) {
		...
		videoPane.setBorder(new CompoundBorder(new LineBorder(Color.black, 1),
	 ...
	 * scrollPane.setViewportView(mediaPlayer); setLayout(groupLayout);
	 */
	...
	public void fireButtonStartStreaming() {
		if (!streaming) {
			...
			try {
				...
				gui.getGUI().logErrTxt(
						"Cannot create output file for video streaming");
			}
		} else {
