...
public class PicturePanel extends JPanel {
	...
	public PicturePanel(UserGUI gui) {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addContainerGap()
						.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 501,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						.createSequentialGroup()
						.addContainerGap()
						.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 400,
								Short.MAX_VALUE).addContainerGap()));
		...
		panel_2 = new JPanel();
		panel_2.setBorder(new TitledBorder(null, "Options",
		...
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(
				...
				gl_panel_1
						.createSequentialGroup()
						.addContainerGap()
						.addComponent(list, GroupLayout.DEFAULT_SIZE, 165,
								Short.MAX_VALUE)
		...
		gl_panel_2.setVerticalGroup(gl_panel_2.createParallelGroup(
				...
				gl_panel_2
						...
						.addComponent(btnTakePicture).addGap(18)));
	...
	private void fireMouseClickedInList() {
		...
		if (!lastTitle.equals(title)) {
			try {
				lastTitle = title;
				Image image = scaleImage(ImageIO.read(new File(title)), 560,
						420);
	...
	public void updateImage(byte[] data) {
		try {
			...
			gui.errLogTxt(System.currentTimeMillis(),
					"Error in creating picture");
		}
	}
