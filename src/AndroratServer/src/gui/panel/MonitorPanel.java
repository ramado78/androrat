...
public class MonitorPanel extends JPanel {
	...
	public MonitorPanel(UserGUI gui, boolean callMonitor) {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addContainerGap()
						.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 493,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						.createSequentialGroup()
						.addContainerGap()
						.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 392,
				...
				gl_panel.createSequentialGroup()
						...
						.addGroup(
								gl_panel.createParallelGroup(Alignment.LEADING)
										.addComponent(phoneNumbersTextArea,
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(
				...
				gl_panel.createSequentialGroup()
						...
						.addComponent(lblNewLabel_2)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(lblNewLabel_3).addGap(12)
						.addComponent(btnStartMonitoring).addContainerGap()));
	...
	private void fireButtonMonitoring() {
		if (monitoring) {
			...
			monitoring = false;
			if (callMonitor)
				gui.fireStopCallMonitoring();
			else
				gui.fireStopSMSMonitoring();
		} else {
			colorPane.setText("");
	...
	public void addMonitoredCall(int type, String phoneNumber) {
		...
		colorPane.append(color, message + phoneNumber + " at "
